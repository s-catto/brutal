...
/*tamanhos da borda e dos quadrados*/
#define BORDER  10
#define SQ_SIDE 120

/*pontos dos quadrados*/
...
typedef struct {
    ALLEGRO_COLOR cores[4];   /*cores dos quadradinhos*/
    ALLEGRO_BITMAP *chrs[5];  /*sprites quadradinhos*/
    int p1;                   /*escolha do player1*/
    int p2;                   /*escolha do player2*/
} character_square;

/*faz o load dos sprites quadradinhos*/
void load_chr_bitmaps(ALLEGRO_BITMAP **chrs);

/*funcao principal, maneja a escolha de personagens, cenarios e modo de jogo*/
...
/*destroi os sprites quadradinhos*/
